/**
 * The program asks for user' input and fill in 2 arrays with random numbers from 1 to 6. Then concatenate the array into a merged array with alternative steps.
 * @author Linh Nguyen
